  ...
  return (
    <SimFrame
      ...
      headerAction={
        <div className="flex items-center gap-3">
          <div className="text-label text-dim font-mono">
    ...
    >
      <div className="space-y-3 font-mono text-caption">
        ...
        {yTrain && yInf && (
          <div className="pt-3 border-t border-border space-y-2 text-label">
            <div>
              ...
              <div className="space-y-0.5">
                {yTrain.y.map((row, i) => (
                  <div key={i} className="font-mono tabular-nums">
                    <span className="text-dim">y[{i}]</span>{' '}
            ...
            {batch === 1 && (
              <p className="text-label text-[rgb(var(--negative))] font-mono leading-relaxed">
