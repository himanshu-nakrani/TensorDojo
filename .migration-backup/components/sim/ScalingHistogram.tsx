    ...
    >
      <div className="space-y-4">
        <div>
          ...
          <div className="text-label text-muted font-mono mb-1 tabular-nums">
          ...
          <div className="text-label text-dim font-mono mt-1 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
          <div>
            ...
            <div className="flex items-center gap-2">
              {D_K_CHOICES.map((d) => (
                <button
                  ...
                  onClick={() => setDK(d)}
                  className={clsx(
                    'px-2.5 py-1 rounded font-mono text-label tabular-nums focus-ring transition-colors',
                    d === dK
                      ? 'bg-accent text-bg'
            ...
            <div className="text-label text-dim font-mono mt-2">
          ...
          <div>
            ...
            <button
              ...
              className={clsx(
                'text-label uppercase tracking-[0.12em] font-mono px-3 py-1.5 rounded border focus-ring transition-colors',
                scale
