...
export const interactives: readonly InteractiveEntry[] = [
  {
    ...
    caption:
      'The green-to-red colormap is the loss surface (green is low, red is high). The black line is the trajectory; the accent dot is the end. Pick a preset, watch the trajectory, and try tuning η between presets to see where oscillation gives way to divergence.',
