...
export const interactives: readonly InteractiveEntry[] = [
  {
    ...
    caption:
      'Drag the stack-depth slider from 1 to 24 layers. The blue line is the per-layer activation norm; the red line is the per-layer gradient norm. With both on, both lines stay roughly flat. Flip residual off and the gradient line diverges; flip layernorm off and the activation line drifts.',
