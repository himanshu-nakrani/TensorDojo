...
export const interactives: readonly InteractiveEntry[] = [
  ...
  },
  {
    ...
    caption:
      'The x-axis is log-scaled. The sweet spot is the lowest point of the red (test) curve; the blue (train) curve is monotone increasing in λ because shrinking the weights away from the data-fitting solution costs fit.',
