...
> = {
  ...
  "data-pipeline": () => import('@/content/lessons/data-pipeline/lesson.mdx'),
  "data-mixtures": () => import('@/content/lessons/data-mixtures/lesson.mdx'),
  "data-deduplication": () => import('@/content/lessons/data-deduplication/lesson.mdx'),
  "context-length": () => import('@/content/lessons/context-length/lesson.mdx'),
  "distributed-data-parallel": () => import('@/content/lessons/distributed-data-parallel/lesson.mdx'),
  "tensor-parallelism": () => import('@/content/lessons/tensor-parallelism/lesson.mdx'),
  "pipeline-parallelism": () => import('@/content/lessons/pipeline-parallelism/lesson.mdx'),
  "zero-and-fsdp": () => import('@/content/lessons/zero-and-fsdp/lesson.mdx'),
  "continuous-batching": () => import('@/content/lessons/continuous-batching/lesson.mdx'),
  "paged-attention": () => import('@/content/lessons/paged-attention/lesson.mdx'),
  "prefix-caching": () => import('@/content/lessons/prefix-caching/lesson.mdx'),
  "reward-modeling": () => import('@/content/lessons/reward-modeling/lesson.mdx'),
  "ppo-rlhf": () => import('@/content/lessons/ppo-rlhf/lesson.mdx'),
  "constitutional-ai": () => import('@/content/lessons/constitutional-ai/lesson.mdx'),
  "rlaif": () => import('@/content/lessons/rlaif/lesson.mdx'),
  "benchmark-design": () => import('@/content/lessons/benchmark-design/lesson.mdx'),
  "calibration": () => import('@/content/lessons/calibration/lesson.mdx'),
  "hallucination-and-grounding": () => import('@/content/lessons/hallucination-and-grounding/lesson.mdx'),
  "prompt-injection": () => import('@/content/lessons/prompt-injection/lesson.mdx'),
  "red-teaming": () => import('@/content/lessons/red-teaming/lesson.mdx'),
  "interpretability": () => import('@/content/lessons/interpretability/lesson.mdx'),
  "multimodal-transformers": () => import('@/content/lessons/multimodal-transformers/lesson.mdx'),
};
