  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 min-w-0">
        <span className="hidden sm:inline-block text-label uppercase tracking-[0.12em] font-mono text-accent shrink-0">
          Resume →
        </span>
        <span className="sm:hidden text-label uppercase tracking-[0.12em] font-mono text-accent shrink-0">
          Resume
        </span>
