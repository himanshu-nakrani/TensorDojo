...
export function ProjectionExplorer({ preset }: { preset?: ProjectionExplorerPreset }) {
  ...
  return (
    <SimFrame
      title="The shadow of a on b · and the leftover residual"
      headerAction={
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-6">
        ...
        <div className="md:w-64 space-y-3 font-mono text-caption tabular-nums">
          ...
          <div className="pt-3 border-t border-border text-label text-dim leading-relaxed">
            <div>
