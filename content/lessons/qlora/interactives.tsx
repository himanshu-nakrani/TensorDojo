...
export const interactives: readonly InteractiveEntry[] = [
  {
    ...
    caption:
      'Full FT is dominated by the red optimizer-state bar (Adam keeps two fp32 buffers per weight). LoRA collapses the right half of the bar; QLoRA additionally shrinks the teal base bar by 4×. At 70B, only the QLoRA and inference bars fit on a single H100 (80 GB).',
