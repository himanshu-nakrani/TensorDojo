...
export const interactives: readonly InteractiveEntry[] = [
  {
    ...
    description:
      'A tiny MLP (3 layers, 123 parameters) on a tiny synthetic 2D 3-class classification task (~200 samples). The reader picks the optimizer, batch size, peak LR, and schedule; hits Train; watches the loss descend (or fail to), the test accuracy converge, and the per-step trajectory.',
    caption:
